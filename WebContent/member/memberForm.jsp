...
/*         function goLoginForm() {
        ...
        function openEmailChk(){
        	window.name="parentForm";
        	window.open("member/emailCheckForm.jsp","chkForm", "width=600, height=300");    		
        }
...
<body>
	<div id="header">
		<a href="first.jsp" target="_self" title="gomain"><img src="css.images/dammylogo.png" id="logo"></a>
	</div>

	<div class="wrap">
		<div class="content">
	     
	           <form method="post" action="MemberAddServlet" name="userInfo" onsubmit="return checkValue()"> <!-- 조건확인 -->
		        	<div>
